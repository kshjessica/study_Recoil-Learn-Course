...
// eslint-disable-next-line no-lone-blocks
{
    ...
    - automatically recompute when atom changes -> makes dependency management easier
    - can use same hook to interact with selectors and atoms
    - selectors are reusable
    - get, set logic is combined in one unit
    */
}
...
export const Selectors = () => {
    ...
    // if set-able, use state
    // if not set-able, use value
    ...
    return (
        <div style={{padding: 20}}>
            ...
            <InputStack>
                ...
                : How to reuse? Make it as a Selector.
                */}
